...
const translate = {
    name: "translate",
    description: "Translate plain text to another language using an LLM via OpenRouter.",
    input: {
        content: {
            type: "string",
            required: true,
    ...
    async execute(input) {
        ...
        if (!apiKey) {
            throw new Error("OPENROUTER_API_KEY environment variable is required for ai.translate");
        }
